...
export default function Button({ as, className, children, variant, loading, disabled, ...props }) {
  ...
  return (
    <Component className={classNames('__button', variantClass, className)} disabled={disabled || loading} {...props}>
